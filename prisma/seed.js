...
const STANDARDS = [
    ...
    // -----------------------------------------------------------------------
    {
        ...
        category: "Core",
        summary: "Get the right connection type and speed for your school or college, and a backup connection to ensure resilience and appropriate safeguarding systems.",
        govUkUrl: "https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/broadband-internet-core-standard",
        weight: 1.0,
        subCriteria: [
            {
                code: "BB-1",
            ...
            },
            {
                ...
                rationale: "DfE: \"Ensure appropriate measures are in place to mitigate against a single point of failure.\"",
                mustHave: true,
                weight: 1.0,
                descriptors: [
    ...
    // -----------------------------------------------------------------------
    {
        ...
        category: "Core",
        summary: "Use the latest wireless network standards for performance, coverage, management and security in your school or college.",
        govUkUrl: "https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/wireless-network-core-standard",
        weight: 1.0,
        subCriteria: [
            {
                code: "WL-1",
    ...
    // -----------------------------------------------------------------------
    {
        ...
        category: "Core",
        summary: "Make sure your school or college has proper network switches and switching infrastructure for reliability, security and resilience.",
        govUkUrl: "https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/network-switching-core-standard",
        weight: 1.0,
        subCriteria: [
            {
                code: "NS-1",
    ...
    // -----------------------------------------------------------------------
    {
        ...
        category: "Core",
        summary: "Have effective digital technology leadership and governance, roles and responsibilities and processes in your school or college.",
        govUkUrl: "https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/digital-leadership-and-governance-core-standard",
        weight: 1.5,
        subCriteria: [
            {
                code: "DL-1",
            ...
            },
            {
                ...
                rationale: "DfE: \"Registers should be printed out to retain hard copies in case of an emergency\" AND kept in a secure cloud folder.",
                mustHave: true,
                weight: 1.0,
                descriptors: [
    ...
    // -----------------------------------------------------------------------
    {
        ...
        category: "Core",
        summary: "Provide a safe online environment for your school or college with appropriate filtering and monitoring systems.",
        govUkUrl: "https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/filtering-and-monitoring-core-standard",
        weight: 1.5,
        subCriteria: [
            {
                code: "FM-1",
            ...
            },
            {
                ...
                rationale: "DfE: \"make sure that your filtering provider is a member of IWF\" and \"signed up to CTIRU.\"",
                mustHave: true,
                weight: 1.3,
                descriptors: [
            ...
            },
            {
                ...
                rationale: "DfE: \"cannot be disabled, overridden, or altered by any user…including system administrators.\"",
                mustHave: true,
                weight: 1.3,
                descriptors: [
    ...
    // -----------------------------------------------------------------------
    {
        ...
        category: "Core",
        summary: "Keep your school or college cyber secure, and control and secure user accounts.",
        govUkUrl: "https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/cyber-security-core-standard",
        weight: 2.0,
        subCriteria: [
            {
                code: "CS-1",
    ...
    // -----------------------------------------------------------------------
    {
        ...
        category: "Additional",
        summary: "Know how to use or move to cloud solutions for your school or college, including managing access, availability, data protection and backup.",
        govUkUrl: "https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/cloud-solutions",
        weight: 1.0,
        subCriteria: [
            {
                code: "CL-1",
    ...
    // -----------------------------------------------------------------------
    {
        ...
        category: "Additional",
        summary: "Make your school or college's digital products, content and services accessible and usable for all.",
        govUkUrl: "https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/digital-accessibility",
        weight: 1.0,
        subCriteria: [
            {
                code: "DA-1",
    ...
    // -----------------------------------------------------------------------
    {
        ...
        title: "IT support",
        category: "Additional",
        summary: "Plan, commission and review your school or college's IT support services to make sure you have suitable support for your digital technology.",
        govUkUrl: "https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/it-support",
        weight: 1.0,
        subCriteria: [
            {
                code: "IT-1",
    ...
    // -----------------------------------------------------------------------
    {
        ...
        category: "Additional",
        summary: "Get the right digital devices for teaching and learning by meeting standards for laptops, desktops and tablets for schools and colleges.",
        govUkUrl: "https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/laptops-desktops-and-tablets",
        weight: 1.0,
        subCriteria: [
            {
                code: "LD-1",
    ...
    // -----------------------------------------------------------------------
    {
        ...
        category: "Additional",
        summary: "Make sure you have the right copper cabling, optical fibre cabling and installation in your school or college.",
        govUkUrl: "https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/network-cabling",
        weight: 1.0,
        subCriteria: [
            {
                code: "NC-1",
    ...
    // -----------------------------------------------------------------------
    {
        ...
        category: "Additional",
        summary: "Make sure you choose the right servers and storage for your school or college, including security, energy efficiency and suitable environments.",
        govUkUrl: "https://www.gov.uk/guidance/meeting-digital-and-technology-standards-in-schools-and-colleges/servers-and-storage",
        weight: 1.0,
        subCriteria: [
            {
                code: "SS-1",
...
async function seed() {
    ...
    try {
        ...
        const v = await client.query(`INSERT INTO standards_version (version, published_at, source_notes)
       VALUES ($1, $2, $3)
       ...
       RETURNING id`, [
        ...
        for (const [stdIdx, std] of STANDARDS.entries()) {
            const stdRes = await client.query(`INSERT INTO standard
         ...
         RETURNING id`, [
            ...
            for (const [scIdx, sc] of std.subCriteria.entries()) {
                const scRes = await client.query(`INSERT INTO sub_criterion
           ...
           RETURNING id`, [
                ...
                for (let level = 1; level <= 5; level++) {
                    await client.query(`INSERT INTO level_descriptor (sub_criterion_id, level, descriptor)
             VALUES ($1, $2, $3)`, [subCriterionId, level, sc.descriptors[level - 1]]);
                }
            }
            console.log(`  ✓ ${std.slug} (${std.subCriteria.length} sub-criteria, ${std.subCriteria.length * 5} descriptors)`);
        }
        await client.query("COMMIT");
        const totalSub = STANDARDS.reduce((n, s) => n + s.subCriteria.length, 0);
        console.log(`\nSeeded ${STANDARDS.length} standards / ${totalSub} sub-criteria / ${totalSub * 5} descriptors as version ${VERSION}.`);
    }
    catch (err) {
