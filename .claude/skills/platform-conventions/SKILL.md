...
description: Rules and conventions for the "DfE Digital Standards - Claude Code" project provisioned on the AI Provisioning Platform — authentication model, what infrastructure is and isn't available, publish + decommission lifecycle, URL path constraint, secrets storage, multi-tenancy. Use when the user asks about platform rules, what they're allowed to do, what infra exists, how publish works, what gets deleted on decommission, how auth flows, or how to integrate with the host service.
---
